...
def create_dataset(data, input2id, target2id, is_cuda, batch_size=4):
    ...
    return DataLoader(dataset=PaddedTensorDataset(seq_tensor, target_tensor, seq_lengths, raw_data), batch_size=batch_size)
